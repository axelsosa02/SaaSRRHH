  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute left-1/2 top-0 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-foreground/[0.035] blur-[140px] dark:bg-foreground/6" />
        <div className="absolute bottom-0 right-0 h-[360px] w-[360px] rounded-full bg-foreground/2.5 blur-[120px] dark:bg-foreground/5" />
        <div className="absolute top-1/2 left-1/4 h-[400px] w-[400px] rounded-full bg-primary/2 blur-[150px] dark:bg-primary/5" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          <motion.div
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-full bg-background/60 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-foreground/70 dark:bg-background/70 dark:text-foreground/80"
          >
          ...
          >
            Contratá <label htmlFor="" className="text-[#b6f300]">mejor</label> {" "} <br />
            <span className="bg-linear-to-r from-primary via-primary/60 to-foreground/80 bg-clip-text text-transparent">
              Contratá más <label htmlFor="" className="text-[#b6f300]">rápido.</label>
            </span>
          </motion.h1>

          <motion.p
            variants={itemVariants}
            className="mx-auto mb-10 max-w-3xl text-lg text-white md:text-2xl"
          >
            Gestioná candidatos, puestos y entrevistas desde un solo lugar y tomá mejores decisiones de <label htmlFor="" className="text-[#b6f300]">contratación.</label>
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="group gap-2 cursor-pointer rounded-xl px-8 py-6 bg-[#b6f300] text-base uppercase tracking-[0.2em]"
            >
              Empezar ahora
              <ArrowRight
