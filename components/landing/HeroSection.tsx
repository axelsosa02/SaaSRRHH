...
export function HeroSection({ content, slug, colorBrand }: HeroSectionProps) {
    return (
        <section
            className="relative min-h-[80dvh] md:h-[80dvh] w-full py-16 md:py-24 lg:py-36 flex items-center overflow-hidden"
            style={{
        ...
        >
            <div className="container max-w-7xl mx-auto px-6 flex flex-col w-full items-center justify-center relative z-10">
                <div className="max-w-full md:max-w-3xl lg:max-w-5xl space-y-6 md:space-y-8 text-center">
                    <h2 className="text-center uppercase tracking-wider text-[#c1a280] font-bold border border-[#c1a280]/30 bg-[#c1a280]/5 py-2 px-6 rounded-full inline-block max-w-full wrap-break-word">
                        {content.cta_tertiary_text}
                    </h2>
                    <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl lg:text-6xl text-[#472825] leading-[1.1] wrap-break-word">
                        {content.title}
                    </h1>
                    {content.subtitle && (
                        <p className="text-lg md:text-xl text-[#96786f] text-center mx-auto leading-relaxed font-medium max-w-xl wrap-break-word whitespace-pre-line">
                            {content.subtitle}
                        </p>
                    )}
                    <div className="pt-6 flex flex-wrap items-center justify-center gap-6">
                        ...
                        {content.cta_secondary_text && (
                            ...
                            >
                                <Link href={content.cta_secondary_url || '#'} >
                                    {content.cta_secondary_text}
                                </Link>
                            </Button>
                        )}
